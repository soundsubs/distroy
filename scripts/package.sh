...
#
# Structure confirmed against docs/MODULES.md and a real published
# module's release.json (timncox/schwung-mark), verified working end to
# end on EMAX_FX:
#   DISTROY-module.tar.gz
#     └── DISTROY/
#         ├── module.json
#         └── DISTROY.so
#
# Requires: scripts/build.sh has already produced build-arm64/DISTROY.so.
...
echo "       version) on your DISTROY repo."
